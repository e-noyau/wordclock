...
class ClockFace {
 public:
  ...
  enum class LightSensorPosition { Bottom, Top };
  ...
  virtual bool stateForTime(int hour, int minute, int second) = 0;
 ...
 protected:
  ...
  enum Corners { TopLeft, BottomLeft, BottomRight, TopRight };
